...
void Main_Joueur::attack_single(Carte* carte_en_main, Carte* carte_cible_fight){
//    print_carte_en_main(carte_en_main);
...
//TODO
//Compare
void Main_Joueur::attack_double(Carte* carte_en_main, Carte* carte_cible_fight){
//    print_carte_en_main(carte_en_main);
//    string first_position("13");
//    string second_position("14");
//    cout << "Please choose the first position corresponding to the carte to fight : " << endl;
//    getline(cin, first_position);
//    cout << "Please choose the second position corresponding to the carte to fight : " << endl;
//    getline(cin, second_position);
//    int first_position_int=test_postion_existed(carte_en_main, first_position);
//    int second_position_int=test_postion_existed(carte_en_main, second_position);
...
//        cout << "Please choose the second position corresponding to the carte to fight : " << endl;
//        getline(cin, second_position);
//        first_position_int=test_postion_existed(carte_en_main, first_position);
//        second_position_int=test_postion_existed(carte_en_main, second_position);
        position_tab = attack_number_carte(1, carte_en_main);
    }
    set_carte_empty(carte_en_main,position_tab);
};
void Main_Joueur::attack_trois(Carte* carte_en_main, Carte* carte_cible_fight){
    print_carte_en_main(carte_en_main);
//    string first_position("13");
//    string second_position("14");
//    string third_position("15");
//    cout << "Please choose the first position corresponding to the carte to fight : " << endl;
//    getline(cin, first_position);
//    cout << "Please choose the second position corresponding to the carte to fight : " << endl;
//    getline(cin, second_position);
//    cout << "Please choose the third position corresponding to the carte to fight : " << endl;
//    getline(cin, third_position);
//    int first_position_int=test_postion_existed(carte_en_main, first_position);
//    int second_position_int=test_postion_existed(carte_en_main, second_position);
//    int third_position_int=test_postion_existed(carte_en_main, third_position);
...
void Main_Joueur::attack_quarte(Carte *carte_en_main, Carte* carte_cible_fight){
...
void Main_Joueur::attack_plural(Carte* carte_en_main, Carte* carte_cible_fight){
    print_carte_en_main(carte_en_main);
    //TODO
